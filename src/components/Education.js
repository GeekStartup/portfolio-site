...
const education = [
  {
    ...
    period: "2007 – 2011",
    details: "Focused on core engineering fundamentals with a strong interest in software systems and problem solving.",
  },
];
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        {education.map((ed, i) => (
          ...
          >
            ...
            {ed.details && <p className="mt-3 text-gray-700 dark:text-gray-200">{ed.details}</p>}
          </motion.article>
        ))}
      </div>
    </SectionWrapper>
